...
#define FICHERO_PID_SNORT "/tmp/WIPS/pid.txt"
#define FICHERO_ARPWATCH "/var/log/arpwatch.log"
#define FICHERO_REGISTRO_REGLAS_MITM "/tmp/WIPS/registro_reglas_MITM"
#define FICHERO_CAPTURA_WIFI "/tmp/WIPS/captura-01.csv"
#define FICHERO_CAPTURA_WIFI_SIN_EXTENSION "/tmp/WIPS/captura"
#define EXTENSION_FICHERO_CAPTURA_WIFI "-01.csv"
#define FICHERO_PID_AIRODUMP "/tmp/WIPS/pid_airodump.txt"
#define FICHERO_REGISTRO_CLIENTES "/tmp/WIPS/registro_clientes.txt"
